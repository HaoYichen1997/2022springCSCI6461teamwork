...
FR0Label = Label(root, text="FR0(16bits)")
FR1Label = Label(root, text="FR1(16bits)")
# Sys Button
...
FR0 = Entry(root, width=60, borderwidth=5)
FR1 = Entry(root, width=60, borderwidth=5)
...
FR0Label.grid(row=6, column=5)
FR1Label.grid(row=7, column=5)
# Entry
...
FR0.grid(row=6, column=6)
FR1.grid(row=7, column=6)
